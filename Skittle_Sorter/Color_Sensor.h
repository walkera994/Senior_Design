...
#define COLOR_SENSOR_ENABLE_WEN           0x00  // R/W Disables wait timer. 
...
*/
#define COLOR_SENSOR_TIMING_ATIME         0xFA  // 2.4ms integration time (FF = 2.4,FA = 6*2.4) 
...
*/
#define COLOR_SENSOR_CONTROL_AGAIN      0x02  // R/W //Set gain to 1
